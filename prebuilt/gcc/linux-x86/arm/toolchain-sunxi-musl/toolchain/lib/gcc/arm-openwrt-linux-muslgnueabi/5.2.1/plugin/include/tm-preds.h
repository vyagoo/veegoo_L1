/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/wangyaliang/workspace/vecoo/out/azalea-aiworld/compile_dir/toolchain/gcc-linaro-5.2-2015.11-2/gcc/config/arm/arm.md'.  */
