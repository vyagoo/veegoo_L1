...
define KernelPackage/sunxi-tvin
  SUBMENU:=$(VIDEO_MENU)
  TITLE:=sunxi-tvin support
  FILES:=$(LINUX_DIR)/drivers/media/v4l2-core/videobuf2-core.ko
  FILES+=$(LINUX_DIR)/drivers/media/v4l2-core/videobuf2-dma-contig.ko
  FILES+=$(LINUX_DIR)/drivers/media/v4l2-core/videobuf2-memops.ko
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-tvd/tvin.ko
  AUTOLOAD:=$(call AutoLoad,95,videobuf2-core videobuf2-dma-contig videobuf2-memops tvin)
endef

define KernelPackage/sunxi-tvin/description
  Kernel modules for sunxi-tvin support
endef

$(eval $(call KernelPackage,sunxi-tvin))
...
define KernelPackage/net-esp8089
  ...
  FILES:=$(LINUX_DIR)/drivers/net/wireless/esp8089/esp_premalloc/esp_prealloc.ko
  FILES+=$(LINUX_DIR)/drivers/net/wireless/esp8089/esp_driver/esp8089.ko
