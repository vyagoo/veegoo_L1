...
ifeq ($(DUMP),)
  PLATFORM_DIR:=$(TOPDIR)/target/veegoo/$(BOARD)
  PLATFORM_COMMON_DIR:=$(TOPDIR)/target/veegoo/$(shell echo -n $(BOARD) | sed -e 's/-.*//g')-common
...
GENERIC_PLATFORM_DIR := $(TOPDIR)/target/veegoo/generic
