...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Purchasing" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Purchasing_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.9.1"
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.9.1/QtPurchasing"
    )
    ...
    macro(_populate_Purchasing_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Purchasing_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Purchasing_check_file_exists(${imported_location})
