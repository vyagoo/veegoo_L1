...
if (NOT TARGET Qt5::Charts)
    ...
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/include/QtCharts/5.9.1"
        "${_qt5Charts_install_prefix}/include/QtCharts/5.9.1/QtCharts"
    )
    ...
    macro(_populate_Charts_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Charts_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Charts_check_file_exists(${imported_location})
