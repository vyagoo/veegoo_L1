...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.9.1"
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.9.1/QtSerialBus"
    )
    ...
    macro(_populate_SerialBus_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5SerialBus_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_SerialBus_check_file_exists(${imported_location})
