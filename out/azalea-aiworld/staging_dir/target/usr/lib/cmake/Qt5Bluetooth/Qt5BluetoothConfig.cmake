...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.9.1"
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.9.1/QtBluetooth"
    )
    ...
    macro(_populate_Bluetooth_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Bluetooth_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Bluetooth_check_file_exists(${imported_location})
