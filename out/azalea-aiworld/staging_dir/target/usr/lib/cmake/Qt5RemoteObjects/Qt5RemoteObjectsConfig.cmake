...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5RemoteObjects" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5RemoteObjects_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.9.1"
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.9.1/QtRemoteObjects"
    )
    ...
    macro(_populate_RemoteObjects_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5RemoteObjects_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_RemoteObjects_check_file_exists(${imported_location})
