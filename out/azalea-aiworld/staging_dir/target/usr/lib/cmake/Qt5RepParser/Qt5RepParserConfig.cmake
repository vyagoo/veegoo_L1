...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5RepParser" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5RepParser_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::RepParser)
    ...
    macro(_populate_RepParser_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5RepParser_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
