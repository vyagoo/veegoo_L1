...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5NetworkAuth" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5NetworkAuth_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.9.1"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.9.1/QtNetworkAuth"
    )
    ...
    macro(_populate_NetworkAuth_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5NetworkAuth_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_NetworkAuth_check_file_exists(${imported_location})
